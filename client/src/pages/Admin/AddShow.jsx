...
function AddShow() {
  ...
  const handleDateTimeAdd = () => {
    ...
    setDateTimeSelection((previous) => ({
      ...previous,
      [date]: [...(previous[date] || []), dateTimeInput],
    }));
    setDateTimeInput("");
  };
          ...
          <div className="flex gap-4 mt-4">
            {nowPlayingMovies.map((movie) => (
              <div
                ...
                className="relative w-40 shrink-0 cursor-pointer hover:-translate-y-1 transition duration-300"
              >
